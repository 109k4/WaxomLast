...
$(document).ready(function(){
    ...
    $('.fa-bars').click(function(){
        $('.header__hidden-links>.header__links-wrapper').slideToggle('fast');
        $('.fa-bars').css({
            "display": "none"
        });
        $('.fa-times').css({
    ...
    $('body').click(function(){
        count ++;
        if(count == 2){
             $('.header__hidden-links>.header__links-wrapper').slideUp('fast');
             $('.fa-bars').css({
                "display": "block"
            });
            $('.fa-times').css({
    ...
    $('.underheader__list li').hover(function(){
        ...
        $(this.getElementsByClassName('underheader__underline')).css({
